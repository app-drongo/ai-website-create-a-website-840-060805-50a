...
export default function Contact() {
  ...
  const offices = [
    ...
    },
    {
      ...
      address: '321 Testing Lane, Building C',
      timezone: 'GMT (UTC+0)',
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Connect with our testing experts to discuss your requirements. We'll help you create the
            perfect testing strategy for your needs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          ...
          <Card className="border-border/50">
            <CardHeader>
              ...
              <CardDescription>
                Tell us about your project and we'll provide a customized testing solution within 24
                hours.
              </CardDescription>
            </CardHeader>
            <CardContent>
