  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Developer Hub', href: '/community' },
        { name: 'Code Examples', href: '/tutorials' },
        { name: 'Tech Talks', href: '/webinars' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Powering enterprise-grade cloud infrastructure with cutting-edge DevOps automation.
                Trusted by Fortune 500 companies for mission-critical deployments and scalable
                solutions.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">enterprise@testsite.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">+1 (800) DEVOPS-1</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get platform updates, security alerts, and DevOps insights. Enterprise-grade privacy
                guaranteed.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Built with <Heart className="size-3 text-red-500 fill-current" /> by DevOps
                engineers
              </span>
            </div>
